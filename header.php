...
<html>
<head>
	<title>Kado Karikatur Digital</title>
		...
		<div class="">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6285156850563</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> penadesignofficial@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Pena Design</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: 	#000000"><b>JASA DESIGN KARIKATUR DIGITAL</b></a>
			</div>
